...
function showErrorWithKey(key) {
  console.log('key keykey key key key ',key);
  console.log('CurrentLang CurrentLang CurrentLang ',CurrentLang);
     if(CurrentLang=='ar'){
       toastr.error(languagesAR[key]);
        }else{
             toastr.error(languages[key]);
        }
